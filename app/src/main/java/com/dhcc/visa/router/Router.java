...
import com.dhcc.visa.common.config.Config;
...
public class Router {
    ...
    private int enterAnim = Config.ROUTER_ANIM_ENTER;
    private int exitAnim = Config.ROUTER_ANIM_EXIT;
